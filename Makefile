...
index:                ## chunk data/kb/, sync retrieval.chunks, embed changed chunks (Voyage)
...
eval-agent:           ## A13 agent vs evals/cases/agent_outcomes.yaml on a 3-plant eval DB (--build first time)
	$(PY) scripts/eval_agent.py $(ARGS)
